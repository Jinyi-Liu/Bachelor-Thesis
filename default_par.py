...
customer_par = {
    ...
    'buy_comment_real': 1 * general_par['comment_bound'],
    'buy_comment_fake': .5 * general_par['comment_bound'],
    'prob_random_buy': 0.1
}
...
regulator_par = {
    ...
    'punishment_comment': .3 * general_par['comment_bound'],
...
parameter_no_review_no_regulator = {
    ...
    'cus': {
        ...
        'buy_comment_real': .5 * general_par['comment_bound'],
        'buy_comment_fake': .5 * general_par['comment_bound'],
        'prob_random_buy': 0,
    },
    'reg': {
...
parameter_with_review_no_regulator = {
    ...
    'cus': {
        ...
        'buy_comment_real': 1 * general_par['comment_bound'],
        'buy_comment_fake': .2 * general_par['comment_bound'],
        'prob_random_buy': 0,
    },
    'reg': {
        'whether_check_market': False
